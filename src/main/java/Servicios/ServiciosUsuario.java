...
public class ServiciosUsuario {
    ...
    public static JsonResponse<TrabajosTaller> queryUsuarioadmin(JsonObject jsonObject) throws SQLException {
        ...
        JsonResponse<TrabajosTaller> response = new JsonResponse<>();
